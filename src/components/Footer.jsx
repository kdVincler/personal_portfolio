        ...
        <div id='contact' className="w-[100%]">
            <section className='mt-[10vh] h-fit w-[100%]'>
                <div className="flexContainer flex justify-center md:flex-row  md:gap-40 flex-col gap-5 items-center">
                    {/* Butten designs lifted from https://daisyui.com/components/button/#login-buttons */}
                    <a 
                        href='mailto:konrad.vincler@gmail.com'
                        target='_blank'
                    >
                        <button className="btn bg-white text-black border-[#e5e5e5] w-[140px]">
                    ...
                    <a 
                        ...
                        target='_blank'
                    >
                        <button className="btn bg-black text-white border-black w-[140px]">
                    ...
                    <a 
                        ...
                        target='_blank'
                    >
                        <button className="btn bg-[#0967C2] text-white border-[#0059b3] w-[140px]">
                ...
                <p className='text-white text-sm mt-[30px] mb-[10px] m-auto w-fit'>
